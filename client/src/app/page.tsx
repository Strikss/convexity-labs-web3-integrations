...
export default function Home() {
	...
	// 				`http:localhost:8080/token-history?address=${USER_ADDRESS}`
	// 			);
	...
	// 		<h1 className="text-2xl font-bold px-4 pt-4">{shortAddress(USER_ADDRESS)}</h1>
	// 		<div className="h-px w-full bg-gray-200" />
	// 		<div className="flex gap-x-4 p-4">
	// 			<div className="flex flex-col gap-4 border border-gray-200 rounded-md p-4">
	// 				<h2 className="text-lg font-bold">HYPE Balance</h2>
	// 				<p>1.23</p>
	// 			</div>
	// 			<div className="flex flex-col gap-4 border border-gray-200 rounded-md p-4">
